...
<body>
    ...
    <a href="../../kpop.html"><img src="../../grafiki/ikona_tytulowa.png" alt="ikona_tytulowa" class="ikonka"/></a>
          ...
          <li><a href="jpop.html">Jpop</a>
            <ul>
                <li><a href="jpop_boysbands.php">Boysbandy</a></li>
                <li><a href="jpop_girlsbands.php">Girlsbandy</a></li>
            </ul>
          </li>
      </ol>
   ...
   <?php 
     ...
     if(isset($_GET['search'])){
        ...
        $sql = "SELECT * FROM jpop_gb WHERE nick LIKE '%$searchKey%' OR imie LIKE '%$searchKey%' OR nazwisko LIKE '%$searchKey%' OR grupa_muzyczna LIKE '%$searchKey%' OR znak_zodiaku LIKE '%$searchKey%' OR data_ur LIKE '%$searchKey%' OR wytwornia_muzyczna LIKE '%$searchKey%'";
     }else
     $sql = "SELECT * FROM jpop_gb";
