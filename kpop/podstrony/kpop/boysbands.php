...
<div>
   ...
   <?php 
     ...
     if(isset($_GET['search'])){
        ...
        $sql = "SELECT * FROM kpop_bb WHERE nick LIKE '%$searchKey%' OR imie LIKE '%$searchKey%' OR nazwisko LIKE '%$searchKey%' OR grupa_muzyczna LIKE '%$searchKey%' OR znak_zodiaku LIKE '%$searchKey%' OR data_ur LIKE '%$searchKey%' OR wytwornia_muzyczna LIKE '%$searchKey%'";
     }else
     $sql = "SELECT * FROM kpop_bb";
