...
<body>
	<header onload="zegarek()">
		<a href="../../kpop.html"><img src="../../grafiki/ikona_tytulowa.png" alt="ikona_tytulowa" class="ikonka"/></a>
	  	<ol>
          <li><a href="../kpop/kpop.html">Grupy Kpop</a>
            <ul>
                <li><a href="../kpop/boysbands.php">Boysbandy</a></li>
                <li><a href="../kpop/girlsbands.php">Girlsbandy</a></li>
                <li><a href="../kpop/Co-edgroups.php">Grupy Co-ed</a></li>
            </ul>
          </li>

          <li><a href="../kpop/solists.html">Soliści Kpop</a>
            <ul>
                <li><a href="../kpop/woman_solist.php">Kobiety</a></li>
                <li><a href="../kpop/man_solist.php">Mężczyźni</a></li>
            </ul>
          </li>

          <li><a href="cpop.html">Cpop</a>
            <ul>
              <li><a href="cpop_boysbands.php">Boysbandy</a></li>
              <li><a href="cpop_girlsbands.php">Girlsbandy</a></li>
            </ul>
          </li>
   ...
   <?php 
     ...
     if(isset($_GET['search'])){
        ...
        $sql = "SELECT * FROM cpop_gb WHERE nick LIKE '%$searchKey%' OR imie LIKE '%$searchKey%' OR nazwisko LIKE '%$searchKey%' OR grupa_muzyczna LIKE '%$searchKey%' OR znak_zodiaku LIKE '%$searchKey%' OR data_ur LIKE '%$searchKey%' OR wytwornia_muzyczna LIKE '%$searchKey%'";
     }else
     $sql = "SELECT * FROM cpop_gb";
